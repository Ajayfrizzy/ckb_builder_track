...
CKB has a dual issuance model:
    ...
    2. **Secondary Issuance**: Constant issuance per epoch (rate approaches zero over time)

## ([Common Knowledge Base (CKB): Understanding Our Ethos](https://www.nervos.org/knowledge-base/ckb_understanding_our_ethos#one_marshmallow_now%2C_or_two_later%3F))

### Practical Work

- Created my second **CCC** App and run it successfully
- ([Created a Spore-studio-App](https://ckb-spore-studio.vercel.app//))
